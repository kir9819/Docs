...
![vue-component](https://ru.vuejs.org/images/vue-component.png)
Мы получили:
...
![vue-component-with-pre](https://ru.vuejs.org/images/vue-component-with-preprocessors.png)
...
2. Example приложения включающего vue , vuex, vue-router: 
http://jsfiddle.net/d30o31r8/
3. Ссылка на проблему, откуда была взята ссылка №2:
https://stackoverflow.com/questions/40871074/decoupled-components-with-centralized-states-in-vuex-vue-router
4. Гайд по созданию одностраничных приложений:
https://tehnojam.pro/category/development/sozdaem-odnostranichnik-s-vue_js.html
